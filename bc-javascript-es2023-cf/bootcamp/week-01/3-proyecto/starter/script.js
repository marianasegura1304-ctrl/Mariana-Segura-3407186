...
// Ejemplo (Planetario): '    PLANETARIO MUNICIPAL - FICHA rgb(17, 163, 139)    '
console.log('=========================================');
console.log('[PLATAFORMA DE NUTRICION PERSONALIZADA] FICHA 0003');
console.log('=========================================');
console.log('');
...
console.log('Valor principal:   ', 1000);
...
console.log('Valor calculado:    ',1000 * 57 ); // TODO: reemplaza 0 con tu cálculo
...
console.log('Total registros:  ', 2000);
...
console.log('¡ DESCUBRE TU DIETA CON JAVA SCRIPT!');
